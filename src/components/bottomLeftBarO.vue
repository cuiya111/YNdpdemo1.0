<template>
  <div ref="chartRef" class="bottomLeftBarO"></div>
  <div class="chartName">计划排产量</div>
</template>
  ...
  if (chartRef.value) {
          ...
          renderItem: (params: any, api: any) => ({
            ...
            style: {
              ...
              stroke: new echarts.graphic.LinearGradient(0, 0, 1, 0, [
                { offset: 0, color: '#0B3554' },
                { offset: 0.55, color: '#04ACC7' },
    ...
    for (let a = 0; a < 80; a++) {
      arr.push({
        ...
        value: 1,
        itemStyle: {
          color: a < 100 - targetPercent ? '#092b45' : '#00FFFF',
        },
      });
    }
